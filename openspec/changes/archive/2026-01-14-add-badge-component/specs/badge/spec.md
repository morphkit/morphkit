...
A notification badge overlay component that displays a count on top of child content. Used for showing unread notifications, cart item counts, or any numeric indicators. Automatically hides when count reaches zero or becomes negative.
