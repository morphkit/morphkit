...
A flexible container component serving as the fundamental building block for layouts. Provides declarative spacing, sizing, border, and flexbox props without writing custom styles.
