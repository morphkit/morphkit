...
The Drawer component provides a themed wrapper around expo-router's Drawer layout that automatically applies morphkit theme tokens to navigation header and drawer panel styling. Drawer eliminates repetitive boilerplate by providing consistent, theme-aware navigation that automatically adapts to light and dark color schemes.
